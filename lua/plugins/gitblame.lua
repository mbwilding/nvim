return {
    ...
    config = function()
        ...
        vim.api.nvim_set_keymap('n', '<leader>gbb', '<cmd>GitBlameToggle<CR>', { noremap = true, silent = true, desc = "Gitblame: Toggle" })
        vim.api.nvim_set_keymap('n', '<leader>gbd', ':SetGitBlameDelay ', { noremap = true, silent = false, desc = "Gitblame: View Delay" })
    end
}
