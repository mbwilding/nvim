...
winget install Kitware.CMake zig.zig BurntSushi.ripgrep.MSVC OpenJS.NodeJS JesseDuffield.lazygit JanDeDobbeleer.OhMyPosh Golang.Go JernejSimoncic.Wget GnuWin32.UnZip GnuWin32.Zip 7zip.7zip python3 RubyInstallerTeam.RubyWithDevKit.3.2 StrawberryPerl.StrawberryPerl jqlang.jq mbuilov.sed
